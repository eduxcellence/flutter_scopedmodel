...
void main() {
  final jobsModel=new JobsScopedModel();
  runApp(ScopedModel<JobsScopedModel>(model:jobsModel,child:JobsApp(jobsModel)));
}
...
class _JobsAppState extends State<JobsApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: OnBoardScreen(),
      routes: {
        "/homepage":(BuildContext context)=> HomePage(widget.model),
